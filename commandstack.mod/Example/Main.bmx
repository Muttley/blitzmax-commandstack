...
Include "Source/TEditor.bmx"
Include "Source/TClearGridCommand.bmx"
Include "Source/TColour.bmx"
Include "Source/TPlotColourCommand.bmx"
...
While Not KeyHit (KEY_ESCAPE) And Not AppTerminate()
	...
	If MouseHit (MOUSE_LEFT)
		commandStack.AddCommand (TPlotColourCommand.Create (MouseX(), MouseY(), currentColour))
	EndIf

	If MouseHit (MOUSE_RIGHT)
		commandStack.AddCommand (TPlotColourCommand.Create (MouseX(), MouseY(), colourBlack))
	EndIf
